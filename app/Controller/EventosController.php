	...
	public function add() {
		if ($this->request->is('post')) {
			...
			if ($this->Evento->save($this->request->data)) {
				$this->Session->setFlash(__('The evento ha sido guardado. Verifique cantidad de recursos'), 'fexito');
		...
		$this->set(compact('eventoTipos', 'clientes', 'recintos', 'recursos', 'empleados', 'actividades'));
	}
