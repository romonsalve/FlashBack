	...
	public function add() {
		if ($this->request->is('post')) {
			...
			if ($this->Evento->save($this->request->data)) {
				$this->Session->setFlash(__('The evento has been saved'), 'fexito');
				return $this->redirect(array('action' => 'index'));
			} else {
				$this->Session->setFlash(__('The evento could not be saved. Please, try again.'), 'ferror');
			}
		}
		...
		$this->set(compact('recintos', 'eventoTipos', 'clientes', 'recursos', 'empleados', 'actividades'));
	}
 ...
 */
	public function delete($id = null) {
		...
		if ($this->Evento->delete()) {
			$this->Session->setFlash(__('Evento deleted'), 'fexito');
			return $this->redirect(array('action' => 'index'));
		}
		$this->Session->setFlash(__('Evento was not deleted'), 'ferror');
		return $this->redirect(array('action' => 'index'));
	}
}
