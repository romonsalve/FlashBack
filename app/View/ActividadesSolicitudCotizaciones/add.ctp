...
<div class="container-fluid">
        ...
        <div class="page-title">
          <h2>!!!Add Actividades Solicitud Cotizacione</h2>
          <hr />
        </div>
        <!-- Title ends -->
	...
	<?php echo $this->TwitterBootstrap->add_crumb("actividadesSolicitudCotizaciones", 'index');echo $this->TwitterBootstrap->add_crumb("Add", null);echo $this->TwitterBootstrap->breadcrumbs(array("divider" => "/")); ?>
        <!-- Breadcrumb ends -->
