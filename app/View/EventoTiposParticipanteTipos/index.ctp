<div class="container-fluid">
            ...
            <div class="box-body">
              <div class="ysheet">
                <div class="bor"></div>
                 <div class="ysheet1">
                    <!-- Title -->
                    <h3>Evento Tipos Participante Tipos</h3>
                    <!-- Para -->
                    <p>Listado de ...</p>
	...
	<?php foreach ($eventoTiposParticipanteTipos as $eventoTiposParticipanteTipo): ?>
		...
		<td class="actions">
			...
			<?php echo $this->Html->link(__('Editar'), array('action' => 'edit', $eventoTiposParticipanteTipo['EventoTiposParticipanteTipo']['id'])); ?>
			<?php echo $this->Form->postLink(__('Borrar'), array('action' => 'delete', $eventoTiposParticipanteTipo['EventoTiposParticipanteTipo']['id']), null, __('¿Estás seguro de que quieres eliminar el elemento #%s?', $eventoTiposParticipanteTipo['EventoTiposParticipanteTipo']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
	...
	?>
	 ...
	 <?php } ?>		
	 <?php } 
		 else {  echo "<hr /> <h1 style='text-align: center'> Aún no se han ingresado Evento Tipos Participante Tipos</h1> <hr />"; } ?>	</div>
	</div>
