...
<div class="container-fluid">
        ...
        <div class="page-title">
          <h2>!!!Add Evento Tipos Participante Tipo</h2>
          <hr />
        </div>
        <!-- Title ends -->
	...
	<?php echo $this->TwitterBootstrap->add_crumb("eventoTiposParticipanteTipos", 'index');echo $this->TwitterBootstrap->add_crumb("Add", null);echo $this->TwitterBootstrap->breadcrumbs(array("divider" => "/")); ?>
        <!-- Breadcrumb ends -->
