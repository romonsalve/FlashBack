...
<div class="container-fluid">
        ...
        <div class="page-title">
          <h2>Edit Proveedores Recurso Tipo</h2>
          <hr />
        </div>
        <!-- Title ends -->
        ...
        <div class="box-body">
          <div class="row-fluid">
            ...
            <div class='span9' >
              <div class="well">
                <h6>Edit Proveedores Recurso Tipo</h6>
                <hr />

	<!--<?php echo __('Edit Proveedores Recurso Tipo'); ?></legend>-->
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ProveedoresRecursoTipo.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('ProveedoresRecursoTipo.id'))); ?></li>
