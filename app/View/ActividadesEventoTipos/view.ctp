...
<li><?php echo "<div class='col-l' style = 'text-align: right;'> Evento Tipos</div>:<div class='col-r' style = 'text-align: left;'> ".$this->Html->link($actividadesEventoTipo['EventoTipos']['id'], array('controller' => 'evento_tipos', 'action' => 'view', $actividadesEventoTipo['EventoTipos']['id']))." &nbsp</div>"; ?> </li><li><?php echo "<div class='col-l' style = 'text-align: right;'> Actividades</div>:<div class='col-r' style = 'text-align: left;'> ".$this->Html->link($actividadesEventoTipo['Actividades']['id'], array('controller' => 'actividades', 'action' => 'view', $actividadesEventoTipo['Actividades']['id']))." &nbsp</div>"; ?> </li></ul>
                              </div>
