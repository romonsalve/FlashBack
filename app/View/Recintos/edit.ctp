...
<div class="container-fluid">
	...
	<?php echo $this->TwitterBootstrap->add_crumb("recintos", 'index');echo $this->TwitterBootstrap->add_crumb("Edit", null);echo $this->TwitterBootstrap->breadcrumbs(array("divider" => "/")); ?>
        <!-- Breadcrumb ends -->
...
'error' => array('attributes' => array('wrap' => 'div', 'class' => 'alert alert-error'))));
		echo '<hr /> ';
				echo $this->Form->input('dimension', array('class' =>'span12','label' => 'Ingrese las dimensiones del recinto', 'placeholder' => '3000 m2',
'error' => array('attributes' => array('wrap' => 'div', 'class' => 'alert alert-error'))));
		echo '<hr /> ';
