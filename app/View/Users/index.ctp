<div class="container-fluid">
	...
	<?php foreach ($users as $user): ?>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Borrar'), array('action' => 'delete', $user['User']['id']), null, __('¿Estás seguro de que quieres eliminar el elemento #%s?', $user['User']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
	...
	?>
	 ...
	 <?php } ?>		
	 <?php } 
		 else {  echo "<hr /> <h1 style='text-align: center'> Aún no se han ingresado Users</h1> <hr />"; } ?>	</div>
	</div>
