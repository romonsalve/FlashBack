<div class="container-fluid">
	...
	<?php foreach ($participanteTipos as $participanteTipo): ?>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Borrar'), array('action' => 'delete', $participanteTipo['ParticipanteTipo']['id']), null, __('¿Estás seguro de que quieres eliminar el elemento #%s?', $participanteTipo['ParticipanteTipo']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
	...
	?>
	 ...
	 <?php } ?>		
	 <?php } 
		 else {  echo "<hr /> <h1 style='text-align: center'> Aún no se han ingresado Participante Tipos</h1> <hr />"; } ?>	</div>
	</div>
