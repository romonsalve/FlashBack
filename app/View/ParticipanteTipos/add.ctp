...
<div class="container-fluid">
	...
	<?php echo $this->TwitterBootstrap->add_crumb("participanteTipos", 'index');echo $this->TwitterBootstrap->add_crumb("Add", null);echo $this->TwitterBootstrap->breadcrumbs(array("divider" => "/")); ?>
        <!-- Breadcrumb ends -->
