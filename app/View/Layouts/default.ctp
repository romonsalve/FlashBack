...
<ul>
                <li><?php echo $this->Html->link('Cotizaciones Pendientes', array('controller'=>'cotizaciones','action' => 'index/pendientes')); ?></li>
<li><?php echo $this->Html->link('Cotizaciones Preaprobadas', array('controller'=>'cotizaciones','action' => 'index/preaprobadas')); ?></li>
<li><?php echo $this->Html->link('Cotizaciones Aprobadas', array('controller'=>'cotizaciones','action' => 'index/aprobadas')); ?></li>
<li><?php echo $this->Html->link('Cotizaciones Rechazadas', array('controller'=>'cotizaciones','action' => 'index/rechazadas')); ?></li>
              </ul>
            </li>
...
<ul>
                <li><?php echo $this->Html->link('Proveedores', array('controller'=>'proveedores','action' => 'index')); ?></li>
<li><?php echo $this->Html->link('Empleados', array('controller'=>'empleados','action' => 'index')); ?></li>
<li><?php echo $this->Html->link('Participantes', array('controller'=>'participantes','action' => 'index')); ?></li>
              </ul>
            </li>

            <li>
<?php echo $this->Html->link('<i class="icon-home icon-white"></i>Eventos Predeterminados ', array(
    'controller' => 'eventoTipos', 'action' => 'index'), array('class'=>'open br-orange','escape' => false) ); ?>    
            </li>
<li class="has_sub">
...
<ul>
                <li><?php echo $this->Html->link('Listaod recursos', array('controller'=>'recursos','action' => 'index')); ?></li>
<li><?php echo $this->Html->link('Definir recursos', array('controller'=>'recursoTipos','action' => 'index')); ?></li>
              </ul>
            </li>
            <li>
<?php echo $this->Html->link('<i class="icon-user icon-white"></i>Personal</a>', array(
    'controller' => 'pages', 'action' => 'home'), array('class'=>'open br-purple','escape' => false) ); ?>
            </li>
            <li>
<?php echo $this->Html->link('<i class="icon-user icon-white"></i>Proveedores</a>', array(
    'controller' => 'pages', 'action' => 'home'), array('class'=>'open br-orange','escape' => false) ); ?>
            </li>
            <li>
<?php echo $this->Html->link('<i class="icon-user icon-white"></i>Participantes</a>', array(
    'controller' => 'pages', 'action' => 'home'), array('class'=>'open br-red','escape' => false) ); ?>
            </li>
            <li>
<?php echo $this->Html->link('<i class="icon-tag icon-white"></i>Vehiculos</a>', array(
    'controller' => 'Vehiculos', 'action' => 'index'), array('class'=>'open br-green','escape' => false) ); ?>
            </li>
          </ul>
        </div>
  </div>
      ...
      <div class="container-fluid">
		...
		<div class="row-fluid">
			<div class="span12">
				...
				<div class="copy">Todos los derechos reservados a Flashback</a></div>
			</div>
		</div>
      </div>
    </div> 
...
<!-- Scroll to top -->
<span class="totop"><a href="#"><i class="icon-chevron-up icon-white"></i></a></span> 
</body>
</html>
