<div class="propiedades index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $propiedade['Propiedade']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $propiedade['Propiedade']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $propiedade['Propiedade']['id']), null, __('Are you sure you want to delete # %s?', $propiedade['Propiedade']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
