 <div class="matter">
      <div class="container-fluid">
        ...
        <ul class="breadcrumb">
          ...
          <li><a href="index"><?php echo __('Evento Tipo'); ?></a> <span class="divider">/</span></li>
		...
		<li><?php echo '<div class="col-l" style = "text-align: right;"> Id </div> '; ?>		<?php echo ":<div class='col-r' style = 'text-align: left;'>".h($eventoTipo['EventoTipo']['id'])." &nbsp</div>";  ?></li>		<li><?php echo '<div class="col-l" style = "text-align: right;"> Nombre Evt </div> '; ?>		<?php echo ":<div class='col-r' style = 'text-align: left;'>".h($eventoTipo['EventoTipo']['nombre_evt'])." &nbsp</div>";  ?></li></ul>
                              </div>
