<div class="container-fluid">
		...
		<hr />
		  <ul class="breadcrumb">
                    ...
                    <li class="active">Evento Tipos</li>
                  </ul>
		<hr />
          <!-- Sheet starts -->
            <div class="box-body">
	...
	<div class="box-body">
        ...
        <thead>
          <tr>
			...
			<th><?php echo $this->Paginator->sort('nombre_evt'); ?></th>
	...
	<?php foreach ($eventoTipos as $eventoTipo): ?>
		...
		<td><?php echo h($eventoTipo['EventoTipo']['nombre_evt']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('Ver'), array('action' => 'view', $eventoTipo['EventoTipo']['id'])); ?>
			<?php echo $this->Html->link(__('Editar'), array('action' => 'edit', $eventoTipo['EventoTipo']['id'])); ?>
			<?php echo $this->Form->postLink(__('Borrar'), array('action' => 'delete', $eventoTipo['EventoTipo']['id']), null, __('¿Estás seguro de que quieres eliminar el elemento #%s?', $eventoTipo['EventoTipo']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
	...
	?>
	 ...
	 <?php } ?>		
	 <?php } 
		 else {  echo "<hr /> <h1 style='text-align: center'> Aún no se han ingresado Evento Tipos</h1> <hr />"; } ?>	</div>
	</div>
