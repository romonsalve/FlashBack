<div class="eventoTipos index">
	<h2><?php echo __('Evento Tipos'); ?></h2>
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $eventoTipo['EventoTipo']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $eventoTipo['EventoTipo']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $eventoTipo['EventoTipo']['id']), null, __('Are you sure you want to delete # %s?', $eventoTipo['EventoTipo']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
