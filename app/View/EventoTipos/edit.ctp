...
<div class="container-fluid">
	...
	<?php echo $this->TwitterBootstrap->add_crumb("eventoTipos", 'index');echo $this->TwitterBootstrap->add_crumb("Edit", null);echo $this->TwitterBootstrap->breadcrumbs(array("divider" => "/")); ?>
        <!-- Breadcrumb ends -->
