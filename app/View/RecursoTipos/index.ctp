<div class="recursoTipos index">
	<h2><?php echo __('Recurso Tipos'); ?></h2>
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $recursoTipo['RecursoTipo']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $recursoTipo['RecursoTipo']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $recursoTipo['RecursoTipo']['id']), null, __('Are you sure you want to delete # %s?', $recursoTipo['RecursoTipo']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
