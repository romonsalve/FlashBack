 <div class="matter">
	...
	<?php echo $this->TwitterBootstrap->add_crumb("propiedadesRecursoTipos", array('controller' => 'PropiedadesRecursoTipo', 'action' => 'index'));echo $this->TwitterBootstrap->add_crumb("Ver Propiedades Recurso Tipo", null);echo $this->TwitterBootstrap->breadcrumbs(array("divider" => "/")); ?>
		...
		<li><?php echo '<div class="col-l" style = "text-align: right;"> Id </div> '; ?>		<?php echo ":<div class='col-r' style = 'text-align: left;'>".h($propiedadesRecursoTipo['PropiedadesRecursoTipo']['id'])." &nbsp</div>";  ?></li><li><?php echo "<div class='col-l' style = 'text-align: right;'> Medidas</div>:<div class='col-r' style = 'text-align: left;'> ".$this->Html->link($propiedadesRecursoTipo['Medidas']['id'], array('controller' => 'medidas', 'action' => 'view', $propiedadesRecursoTipo['Medidas']['id']))." &nbsp</div>"; ?> </li><li><?php echo "<div class='col-l' style = 'text-align: right;'> Propiedades</div>:<div class='col-r' style = 'text-align: left;'> ".$this->Html->link($propiedadesRecursoTipo['Propiedades']['id'], array('controller' => 'propiedades', 'action' => 'view', $propiedadesRecursoTipo['Propiedades']['id']))." &nbsp</div>"; ?> </li><li><?php echo "<div class='col-l' style = 'text-align: right;'> Recurso Tipos</div>:<div class='col-r' style = 'text-align: left;'> ".$this->Html->link($propiedadesRecursoTipo['RecursoTipos']['id'], array('controller' => 'recurso_tipos', 'action' => 'view', $propiedadesRecursoTipo['RecursoTipos']['id']))." &nbsp</div>"; ?> </li>		<li><?php echo '<div class="col-l" style = "text-align: right;"> Maximo  Medida </div> '; ?>		<?php echo ":<div class='col-r' style = 'text-align: left;'>".h($propiedadesRecursoTipo['PropiedadesRecursoTipo']['maximo__medida'])." &nbsp</div>";  ?></li>		<li><?php echo '<div class="col-l" style = "text-align: right;"> Minimo Medida </div> '; ?>		<?php echo ":<div class='col-r' style = 'text-align: left;'>".h($propiedadesRecursoTipo['PropiedadesRecursoTipo']['minimo_medida'])." &nbsp</div>";  ?></li></ul>
                              </div>
