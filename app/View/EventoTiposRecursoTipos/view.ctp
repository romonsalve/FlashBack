 <div class="matter">
      <div class="container-fluid">
        ...
        <!-- Breadcrumb starts -->
	<?php echo $this->TwitterBootstrap->add_crumb("eventoTiposRecursoTipos", array('controller' => 'EventoTiposRecursoTipo', 'action' => 'index'));echo $this->TwitterBootstrap->add_crumb("Ver Evento Tipos Recurso Tipo", null);echo $this->TwitterBootstrap->breadcrumbs(array("divider" => "/")); ?>
        <!-- Breadcrumb ends -->
        <hr />
        <div class="box-body">
