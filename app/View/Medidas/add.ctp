...
<div class="container-fluid">
        ...
        <div class="page-title">
          <h2>Agregando una unidad de medida.</h2>
          <hr />
        </div>
        <!-- Title ends -->
	...
	<?php echo $this->TwitterBootstrap->add_crumb("medidas", 'index');echo $this->TwitterBootstrap->add_crumb("Add", null);echo $this->TwitterBootstrap->breadcrumbs(array("divider" => "/")); ?>
        <!-- Breadcrumb ends -->
